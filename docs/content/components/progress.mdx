...
Progress is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Progress } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Progress className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
