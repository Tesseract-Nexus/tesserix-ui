...
Select is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Select } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Select className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
