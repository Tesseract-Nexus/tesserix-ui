...
Color Picker is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { ColorPicker } from "@tesseract-nexus/tesserix-ui"
~~~
...
<ColorPicker className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
