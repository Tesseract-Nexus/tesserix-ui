...
Command is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem, CommandShortcut, CommandSeparator, CommandDialog } from "@tesseract-nexus/tesserix-ui"
~~~
...
export type { CommandProps, CommandItemProps } from "./command"
~~~
...
<Command className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
