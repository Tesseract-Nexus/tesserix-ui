...
Breadcrumb is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage, BreadcrumbSeparator, BreadcrumbEllipsis } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Breadcrumb className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
