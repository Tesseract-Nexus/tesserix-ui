...
Context Menu is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { ContextMenu, ContextMenuTrigger, ContextMenuContent, ContextMenuItem, ContextMenuSeparator, ContextMenuLabel, ContextMenuShortcut } from "@tesseract-nexus/tesserix-ui"
~~~
...
<ContextMenu className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
