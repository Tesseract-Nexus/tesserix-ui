...
Date Picker is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { DatePicker } from "@tesseract-nexus/tesserix-ui"
~~~
...
<DatePicker className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
