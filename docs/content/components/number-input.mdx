...
Number Input is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { NumberInput } from "@tesseract-nexus/tesserix-ui"
~~~
...
<NumberInput className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
