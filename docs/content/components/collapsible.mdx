...
Collapsible is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Collapsible className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
