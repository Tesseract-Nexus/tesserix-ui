...
Pagination is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Pagination, PaginationContent, PaginationItem, PaginationLink, PaginationPrevious, PaginationNext, PaginationEllipsis } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Pagination className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
