...
App Shell is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { AppShell, AppShellSidebar, AppShellMain, AppShellHeader, AppShellContent, AppShellFooter } from "@tesseract-nexus/tesserix-ui"
~~~
...
<AppShell className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
