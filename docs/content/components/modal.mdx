...
Modal is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Modal, ModalTrigger, ModalContent, ModalHeader, ModalFooter, ModalTitle, ModalDescription, ModalClose } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Modal className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
