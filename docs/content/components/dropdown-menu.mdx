...
Dropdown Menu is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuLabel, DropdownMenuShortcut } from "@tesseract-nexus/tesserix-ui"
~~~
...
<DropdownMenu className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
