...
Separator is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Separator } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Separator className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
