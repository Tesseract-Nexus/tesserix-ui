...
Aspect Ratio is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { AspectRatio } from "@tesseract-nexus/tesserix-ui"
~~~
...
<AspectRatio className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
