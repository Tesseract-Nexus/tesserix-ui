...
Combobox is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Combobox } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Combobox className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
