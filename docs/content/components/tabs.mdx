...
Tabs is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Tabs, TabsList, TabsTrigger, TabsContent } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Tabs className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
