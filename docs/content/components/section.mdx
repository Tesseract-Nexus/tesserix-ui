...
Section is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Container, Section, SectionHeader, SectionTitle, SectionDescription } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Container className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
