...
Table is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Table, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Table className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
