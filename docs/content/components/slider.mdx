...
Slider is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Slider } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Slider className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
