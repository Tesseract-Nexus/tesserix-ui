...
Input is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { Input } from "@tesseract-nexus/tesserix-ui"
~~~
...
<Input className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
