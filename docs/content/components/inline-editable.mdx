...
Inline Editable is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { InlineEditable } from "@tesseract-nexus/tesserix-ui"
~~~
...
<InlineEditable className="w-full" />
~~~
...
<InlineEditable className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
