...
Hero Section is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { HeroSection, HeroEyebrow, HeroTitle, HeroDescription, HeroActions, HeroVisual } from "@tesseract-nexus/tesserix-ui"
~~~

## Exports

~~~ts
export { HeroSection, HeroEyebrow, HeroTitle, HeroDescription, HeroActions, HeroVisual } from "./hero-section"
~~~
...
<HeroSection className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
