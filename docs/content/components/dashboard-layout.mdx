...
Dashboard Layout is a design-system component intended for reusable, product-agnostic UI composition.

## Import

~~~tsx
import { DashboardLayout, DashboardLayoutHeader, DashboardLayoutBody, DashboardLayoutMain, DashboardLayoutRail } from "@tesseract-nexus/tesserix-ui"
~~~
...
<DashboardLayout className="bg-[#123456] text-[#fafafa] px-[13px]" />
~~~
